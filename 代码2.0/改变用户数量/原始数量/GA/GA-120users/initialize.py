...
def initialize_topology():
    ...
    # 用户请求服务数据大小初始化(MB)
    data_in = np.random.uniform(0.05, 0.1, n)
    data_out = np.random.uniform(0.05, 0.1, n)
    ...
    t_delay_c = np.random.uniform(10, 20, n)
    ...
    cost_cloud = {"p_net": 10}  # 云服务器成本单价
    max_cost = 20000  # 最大允许总成本
