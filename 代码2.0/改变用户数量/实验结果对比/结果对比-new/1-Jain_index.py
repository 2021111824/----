...
if __name__ == "__main__":
    ...
    jian_indexes = {
        ...
        'FCGDO': [0.9949, 0.9972, 0.9949, 0.9902, 0.9769],
        'GA': [0.9937, 0.9941, 0.9894, 0.9899, 0.9576],
        'Optimal': [0.9637, 0.9723, 0.9585, 0.9727, 0.9463],
        'Greedy': [0.9727, 0.9736, 0.9539, 0.9699, 0.9434],
        'Random': [0.7115, 0.8383, 0.7643, 0.8861, 0.8201]
    }
    ...
    ax.set_ylim(0.70, 1.0)  # 设置纵坐标范围
    ax.set_yticks(np.arange(0.70, 1.00, 0.05))  # 设置纵坐标刻度
