...
if __name__ == "__main__":
    ...
    # ========== 运行贪心算法 ==========
    result, best_jain, best_response_times = gsafo(n, m_edge, m_cloud, priorities, weights, cost_edge, cost_cloud, max_cost, T_max,
    ...
    if result is None:
        ...
        # 响应时间赋值
        response_times = best_response_times
