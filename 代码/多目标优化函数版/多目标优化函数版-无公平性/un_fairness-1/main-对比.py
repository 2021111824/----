...
if __name__ == "__main__":
    ...
    weights = simulation_data['weights_1']
    ...
    cpu_demands = simulation_data['cpu_demands_1']
    mem_demands = simulation_data['mem_demands_1']
    bandwidth_demands = simulation_data['bandwidth_demands_1']
