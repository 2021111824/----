...
if __name__ == "__main__":
    ...
    # ========== 遗传算法求解 ==========
    best_solution, best_fitness, jain_fairness, response_deviation, best_response_times, fitness_history, \
        best_jain_fairness_history, best_response_deviation_history = genetic_algorithm(
