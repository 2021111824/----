...
if __name__ == "__main__":
    ...
    for i in range(len(user_positions)):
        ...
        response_time = compute_response_time(
            ...
            request_sizes[i], v_edge, v_cloud, b_edge, b_cloud, best_solution, cpu_demands, mem_demands, bandwidth_demands, R_cpu, R_mem, R_bandwidth, m_edge, m_cloud
        )
