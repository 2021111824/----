                ...
                if server_cpu_usage[server_idx] > R_cpu[server_idx] or \
                    ...
                    if valid_edge_servers:
                        ...
                        if valid_cloud_servers:
                            ...
                            # 重新分配计算能力
                            user_capacities = assign_computational_capacity(individual, user_positions,
                                                                            server_positions, request_sizes, P_edge,
                                                                            P_cloud, m_edge, priorities)
