...
def initialize_topology(n, m_edge, m_cloud):
    ...
    request_sizes = np.random.uniform(0.5, 12.0, n)  # 请求大小 (MB/s)
    ...
    bandwidth_demands = request_sizes * 1.0  # 假设每MB请求需要1Mbps带宽
    ...
    return user_positions, request_sizes, priorities, server_positions, R_cpu, R_mem, R_bandwidth, cpu_demands, \
