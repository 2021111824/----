...
if __name__ == "__main__":
    ...
    jian_indexes = {
        ...
        'FCGDO': [0.9994, 0.9990, 0.9993, 0.9980, 0.9976, 0.9743],
        'GA': [0.9985, 0.9982, 0.9988, 0.9969, 0.9875, 0.9633],
        'Optimal': [0.9707, 0.9559, 0.9626, 0.9611, 0.9321, 0.8742],
        'Greedy': [0.9454, 0.9545, 0.9607, 0.9319, 0.9365, 0.8520],
        'Random': [0.8582, 0.8850, 0.9383, 0.8768, 0.8921, 0.8621]
    }
