        ...
        for i in range(n_users):
            ...
            if (math.ceil((server_compute_capability[server_idx]) / p_m) * r_m <= R_edge[server_idx] or
                ...
                valid_servers = [
                    ...
                    if (math.ceil((server_compute_capability[new_server_idx] + p_user[i]) / p_m) * r_m <= R_edge[new_server_idx])
                ]
                ...
                if valid_servers:
                    ...
                    server_compute_capability[new_server_idx] += p_user[i]
                    ...
                    response_times[i] = compute_response_time(
                        ...
                        user_data[i], user_bandwidth[i], p_user[i], P_allocation[i]
                    )
