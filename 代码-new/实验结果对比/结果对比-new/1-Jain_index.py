...
if __name__ == "__main__":
    ...
    jian_indexes = {
        'Gurobi': [0.9957, 0.9928, 0.9927, 0.9908],
        'GSAFO': [0.9935, 0.9916, 0.9883, 0.9745],
        'GA': [0.9947, 0.9881, 0.9829, 0.9534],
        'Greedy': [0.9812, 0.9736, 0.9878, 0.9265],
        'Random': [0.9288, 0.8457, 0.8541, 0.8811]
    }
    ...
    ax.set_title('Jain fairness index of Different number of users')
