...
if __name__ == "__main__":
    ...
    response_times_1 = {
        'Gurobi': [15.93, 13.69, 13.84, 13.44],
        'GSAFO': [15.86, 13.34, 13.80, 12.73],
        'GA': [15.63, 13.30, 13.69, 13.27],
        'Greedy': [15.85, 13.25, 13.52, 12.84],
        'Random': [16.30, 14.21, 14.12, 13.84]
    }

    response_times_2 = {
        'Gurobi': [11.80, 9.85, 9.75, 9.13],
        'GSAFO': [11.66, 9.73, 10.23, 9.51],
        'GA': [11.35, 9.75, 10.08, 9.29],
        'Greedy': [11.63, 10.22, 10.13, 10.40],
        'Random': [13.13, 11.80, 11.14, 10.48]
    }

    response_times_3 = {
        'Gurobi': [8.87, 7.77, 7.92, 7.63],
        'GSAFO': [9.76, 7.98, 8.19, 8.26],
        'GA': [9.25, 8.30, 8.05, 7.80],
        'Greedy': [9.65, 8.15, 8.26, 8.56],
        'Random': [9.33, 11.45, 11.04, 8.87]
    }
