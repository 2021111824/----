...
if __name__ == "__main__":
    ...
    costs = {
        'Gurobi': [241.38, 226.93, 212.16, 321.43],
        'GSAFO': [213.97, 214.22, 280.51, 271.67],
        'GA': [226.05, 264.79, 358.59, 489.52],
        'Greedy': [238.97, 225.85, 227.88, 333.76],
        'Random': [373.08, 454.84, 458.97, 489.66]
    }
