...
def compute_fitness(individual, n, m_edge, m_cloud, user_data,
    ...
    return -total_response_time, response_times
...
def genetic_algorithm(n, m_edge, m_cloud, priorities, R_bandwidth, cost_edge, cost_cloud,
    ...
    for g in tqdm(range(G_max), desc="Running Genetic Algorithm"):
        ...
        for ind in population:
            fitness, response_time = compute_fitness(ind, n, m_edge, m_cloud, user_data, R_bandwidth, t_delay_e, t_delay_c, p_user, P_allocation)
